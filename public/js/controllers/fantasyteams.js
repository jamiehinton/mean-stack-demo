window.angular.module('ngff.controllers.fantasyTeams', []).controller().controller('FantasyTeamsController', ['$scope', '$routeParams', '$location', 'Global', 'Leagues', 'FantasyTeams',
